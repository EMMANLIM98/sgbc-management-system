...
const nav: NavItem[] = [
  ...
  { to: "/committee", label: "Committee", icon: ClipboardList, soon: true },
  { to: "/visitation", label: "Visitation", icon: HomeIcon, soon: true },
  { to: "/outreach", label: "Outreach", icon: MapPin, soon: true },
